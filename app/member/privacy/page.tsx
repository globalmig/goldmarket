...
export default function PrivacyPage() {
    return(
        <PrivacyLayout title="개인정보처리방침">
            ...
            - 서비스 신청시 : 주소, 결제 정보</p><p>o 
서비스 이용 과정이나 사업 처리 과정에서 서비스이용기록, 접속로그, 쿠키, 접속 IP, 결제 기록, 불량이용 기록이 생성되어 수집될 수 있습니다. </p><p>나. 수집방법<br/>
            ...
            o 위탁 대상자 : [택배사 이름]<br/>
            o 위탁업무 내용 : [택배사 위탁 내용]</p><p>o 
위탁 대상자 : [PG사 이름]<br/>
            o 위탁업무 내용 : [PG사 위탁 내용]</p><p>o 
위탁 대상자 : 공급업체 목록보기<br/>
